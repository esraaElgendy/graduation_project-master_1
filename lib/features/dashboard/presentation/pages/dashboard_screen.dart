...
class DashboardScreen extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildStatCard(
                ...
                AppConstants.remainingCreditHours.toString(), 
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text("${AppConstants.completedCreditHours} / ${AppConstants.totalCreditHours}"),
                      ],
                    ),
                    const SizedBox(height: 10),
                    LinearProgressIndicator(
                      value: AppConstants.completedCreditHours / AppConstants.totalCreditHours,
                    ...
                    const SizedBox(height: 10),
                     Text(
                      "${((AppConstants.completedCreditHours / AppConstants.totalCreditHours) * 100).toStringAsFixed(1)}% ${l10n.overallProgress}",
  ...
  Widget _buildStatCard(BuildContext context, String title, String value, IconData icon, Color bgColor, Color iconBgColor) {
    // Only use iconBgColor if you want the circle background to match the light theme card style 
    // or adapt for dark mode interaction.
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
